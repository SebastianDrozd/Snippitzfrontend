...
export const getAllPosts = () => {
   return  axios.get('https://snippitzio.herokuapp.com/api/posts/query?pageSize=16')
...
export const requestPageAble= (pageNumber) => {
    ...
    return axios.get(`https://snippitzio.herokuapp.com/api/posts/query?pageSize=16&pageNo=${pageNumber}`)
}
...
export const getPostQueryable = (sortBy) => {
    
    return axios.get(`https://snippitzio.herokuapp.com/api/posts/query?sortBy=${sortBy}`)
}

export const getPostsByAuthor = (author) => {
        return axios.get(`https://snippitzio.herokuapp.com/api/posts/author/${author}`)
}