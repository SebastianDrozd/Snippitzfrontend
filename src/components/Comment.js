...
import { deleteComment, getAllComments2, updateComment } from "./connections/Requests";
      ...
      <li>
        <div className="comment-main-level animate__animated animate__zoomIn">
          ...
          <div className="comment-box">
            ...
            {wantsEdit === false && <div className="comment-content">{comment.commentMessage}</div>}
            {wantsEdit &&<> <textarea
            ...
            {username === comment.snipUser ?  <div style={{float: 'right',marginBottom: 10}}>
            <button
              type="button"
